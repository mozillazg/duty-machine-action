...
const captureWebsite = async (input, options) => {
	...
	await fixForWechat(page, timeoutInSeconds);
...
async function fixForWechat(page, timeoutSecondsForImageLoading) {
	await page.evaluate(() => {
		let promises = Array.from(document.querySelectorAll('.img_loading')).map(img => {
			let timeout = new Promise(resolve => {
			  setTimeout(resolve, timeoutSecondsForImageLoading * 1000)
			})
